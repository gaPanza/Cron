...
entities={
    @EntityResult(entityClass=br.com.cron.classes.PedidosPluneDTO.class)
})
@Entity
@Table(name="PedidosPlune")
@NamedQuery(name="PedidosPluneDTO.findAll", query="SELECT p FROM PedidosPluneDTO p")
public class PedidosPluneDTO implements Serializable {
