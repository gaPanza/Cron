...
public class SendToCompanyDTO {
	...
	private ArrayList<SendToCompanyRequestsDTO> pedido;
	
	public ArrayList<SendToCompanyRequestsDTO> getPedido() {
		return pedido;
	}
	public void setPedido(ArrayList<SendToCompanyRequestsDTO> pedido) {
		this.pedido = pedido;
	}
